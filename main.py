...
def create_window():
    ...
    #cmds.menuItem(label="Normal")
    #cmds.setParent('..')    
    #cmds.button(label='Create Eye Shit', command=lambda x:tools.aimOnCurveAdapt(txt_nom_Centre,int_path,enum_dropdown_Aim,cbObjUp_Aim,int_DrvJnt),width=150)
    cmds.button(label='Create Eye Shit', command=lambda x:tools.aimOnCurveAdapt(txt_nom_Centre,int_DrvJnt),width=150)
